...
function Form(props){
    ...
    return(
        <div className="w-75  sm:w-120 h-100 p-8 border-1 border-white rounded-xl bg-white/30 backdrop-blur-sm flex flex-col justify-center items-start space-y-3 text-white selection:bg-purple-900">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col space-y-3 ">
                ...
                placeholder="Email" 
                required 
                className="w-55 sm:w-100 border-b-1 h-9 outline-0 caret-purple-950"/>
                ...
                required 
                className="w-55 sm:w-100  h-9 outline-0 caret-purple-950"/>
                ...
                <button type="submit" className="border-1 w-21 h-9 rounded-xl self-center cursor-pointer hover:bg-white hover:text-purple-800 hover:border-0 ">{props.heading}</button>
            </form>
